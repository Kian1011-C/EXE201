      ...
      <section className="bg-[#0f2942] text-white py-16 px-4 md:px-8">
        <div className="max-w-5xl mx-auto text-center space-y-4">
          ...
          <h1 className="text-3xl md:text-5xl font-black tracking-tight">
            Our Texas Offices & Service Hubs
          </h1>
          <p className="text-base text-gray-300 max-w-2xl mx-auto">
            Convenient physical offices in Katy, Houston (Kirkwood), and Garland (DFW), backed by nationwide telephone consultation available 24/7.
          </p>
        </div>
      </section>
              ...
              <div className="lg:col-span-7 space-y-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-xs font-semibold text-gray-500">Texas Licensed Agency Branch</span>
                  </div>
                  {loc.isHQ && (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs md:text-sm text-gray-600 pt-2">
                  <div className="space-y-1 bg-gray-50 p-4 rounded-2xl border border-gray-100">
                    <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider block">Office Address:</span>
                    <p className="font-bold text-gray-900">{loc.address}</p>
                    <p className="font-semibold text-gray-800">{loc.city}</p>
                  </div>

                  <div className="space-y-1 bg-gray-50 p-4 rounded-2xl border border-gray-100">
                    <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider block">Phone Contact:</span>
                    <a href={`tel:${loc.phoneRaw}`} className="font-bold text-blue-900 hover:underline block text-base">
                      {loc.phone}
                    </a>
                    <span className="text-emerald-700 font-semibold text-xs">● Phone Available 24/7</span>
                  </div>
                </div>
