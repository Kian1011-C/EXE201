...
export default function CommandPaletteModal({
  ...
  const adminCommands = [
    ...
    },
    {
      ...
      category: 'Admin Navigation',
      title: 'Contacts Directory & Client Profiles',
      subtitle: 'Inspect all insured client profiles, household data & documents',
      icon: 'person_search',
    ...
    },
    {
      id: 'admin-nav-deals',
      category: 'Admin Navigation',
      title: 'Deals Workspace & Master AOR',
      subtitle: 'Pipeline Kanban, deal stages and master broker-of-record governance',
      icon: 'handshake',
    ...
    },
    {
      ...
      category: 'Admin Navigation',
      title: 'Service Tickets & SLA Queue',
      subtitle: 'Manage client claims, ACA support, and post-sale service requests',
    ...
    },
    {
      id: 'admin-nav-tasks',
      category: 'Admin Navigation',
      title: 'Team Tasks & Operational Kanban',
      subtitle: 'Track team follow-ups, ACA setup, and compliance tasks',
      icon: 'checklist',
